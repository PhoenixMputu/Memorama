    ...
    <header className="bg-white">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6" aria-label="Global">
        ...
        <div className="flex justify-end gap-5 items-center">
          <Link href="#" className="text-sm border border-blue-500 bg-blue-500 hover:bg-blue-600 focus:outline focus:outline-offset-1 focus:outline-blue-400 active:bg-blue-700 font-medium font-heebo px-4 py-2 rounded text-white">
